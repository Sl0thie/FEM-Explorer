...
namespace FEM_Explorer
{
    internal class Segment
    {
        ...
        internal Segment(int _index, Member _parent, Node _nodeNear, Node _nodeFar, Section _section, decimal _LDLNear, decimal _LDLFar, int _previousSegment)
        {
            ...
            catch (Exception ex) { Debug.WriteLine("Error Segment Construction " + ex.Message); }
        }
        ...
        internal void UpdatePropertiesFromMatrix()
        {
            ...
            switch (SuperPositionProcess)
            {
                case 0:// Process based on individual constraint type.
                    ...
                    if (nodeNear.Constraints.X) { nodeNear.LoadReaction = new FEM_Explorer.NodalLoad(nodeNear.LoadReaction.X - nodeNear.SuperPosition.X, nodeNear.LoadReaction.Y, nodeNear.LoadReaction.M); }
                    if (nodeNear.Constraints.Y) { nodeNear.LoadReaction = new FEM_Explorer.NodalLoad(nodeNear.LoadReaction.X, nodeNear.LoadReaction.Y - nodeNear.SuperPosition.Y, nodeNear.LoadReaction.M); }
                    if (nodeNear.Constraints.M) { nodeNear.LoadReaction = new FEM_Explorer.NodalLoad(nodeNear.LoadReaction.X, nodeNear.LoadReaction.Y, nodeNear.LoadReaction.M - nodeNear.SuperPosition.M); }

                    if (nodeFar.Constraints.X) { nodeFar.LoadReaction = new FEM_Explorer.NodalLoad(nodeFar.LoadReaction.X - nodeFar.SuperPosition.X, nodeFar.LoadReaction.Y, nodeFar.LoadReaction.M); }
                    if (nodeFar.Constraints.Y) { nodeFar.LoadReaction = new FEM_Explorer.NodalLoad(nodeFar.LoadReaction.X, nodeFar.LoadReaction.Y - nodeFar.SuperPosition.Y, nodeFar.LoadReaction.M); }
                    if (nodeFar.Constraints.M) { nodeFar.LoadReaction = new FEM_Explorer.NodalLoad(nodeFar.LoadReaction.X, nodeFar.LoadReaction.Y, nodeFar.LoadReaction.M - nodeFar.SuperPosition.M); }
                ...
                case 1:// Process only Fully Fixed nodes.
                    ...
                    {
                        nodeNear.LoadReaction = new FEM_Explorer.NodalLoad(nodeNear.LoadReaction.X - nodeNear.SuperPosition.X, nodeNear.LoadReaction.Y, nodeNear.LoadReaction.M);
                        nodeNear.LoadReaction = new FEM_Explorer.NodalLoad(nodeNear.LoadReaction.X, nodeNear.LoadReaction.Y - nodeNear.SuperPosition.Y, nodeNear.LoadReaction.M);
                        nodeNear.LoadReaction = new FEM_Explorer.NodalLoad(nodeNear.LoadReaction.X, nodeNear.LoadReaction.Y, nodeNear.LoadReaction.M - nodeNear.SuperPosition.M);

                        nodeFar.LoadReaction = new FEM_Explorer.NodalLoad(nodeFar.LoadReaction.X - nodeFar.SuperPosition.X, nodeFar.LoadReaction.Y, nodeFar.LoadReaction.M);
                        nodeFar.LoadReaction = new FEM_Explorer.NodalLoad(nodeFar.LoadReaction.X, nodeFar.LoadReaction.Y - nodeFar.SuperPosition.Y, nodeFar.LoadReaction.M);
                        nodeFar.LoadReaction = new FEM_Explorer.NodalLoad(nodeFar.LoadReaction.X, nodeFar.LoadReaction.Y, nodeFar.LoadReaction.M - nodeFar.SuperPosition.M);
                    }
                    else
                    {
            ...
            angleDisplaced = Convert.ToDecimal(Math.Atan2(nodeFar.PositionDisplaced.Location.Y - nodeNear.PositionDisplaced.Location.Y,
        ...
        private void CreateSuperpositionValues(DecimalMatrix superposition_local)
        {
            ...
            nearSuperGlobal = new FEM_Explorer.NodalLoad(
                superposition_global[0, 0],
                superposition_global[1, 0],
                superposition_global[2, 0]
                );

            farSuperGlobal = new FEM_Explorer.NodalLoad(
            ...
            nearSuperLocal = new FEM_Explorer.NodalLoad(
                superposition_local[0, 0],
                superposition_local[1, 0],
                superposition_local[2, 0]
                );

            farSuperLocal = new FEM_Explorer.NodalLoad(
