...
namespace FEM_Explorer
{
    public sealed partial class PanelMember : Page
    {
        ...
        {
            Model.Members.CurrentMember.NodeNear.Load = new FEM_Explorer.NodalLoad(doubleValue_LoadsX.NearValue, Model.Members.CurrentMember.NodeNear.Load.Y, Model.Members.CurrentMember.NodeNear.Load.M);
        ...
        {
            Model.Members.CurrentMember.NodeFar.Load = new FEM_Explorer.NodalLoad(doubleValue_LoadsX.FarValue, Model.Members.CurrentMember.NodeFar.Load.Y, Model.Members.CurrentMember.NodeFar.Load.M);
            doubleValue_LoadsX.SetValue(doubleValue_LoadsX.NearValue, doubleValue_LoadsX.FarValue);
        }
        ...
        {
            Model.Members.CurrentMember.NodeNear.Load = new FEM_Explorer.NodalLoad(Model.Members.CurrentMember.NodeNear.Load.X, doubleValue_LoadsY.NearValue, Model.Members.CurrentMember.NodeNear.Load.M);
        ...
        {
            Model.Members.CurrentMember.NodeFar.Load = new FEM_Explorer.NodalLoad(Model.Members.CurrentMember.NodeFar.Load.X, doubleValue_LoadsY.FarValue, Model.Members.CurrentMember.NodeFar.Load.M);
            doubleValue_LoadsY.SetValue(doubleValue_LoadsY.NearValue, doubleValue_LoadsY.FarValue);
        }
        ...
        {
            Model.Members.CurrentMember.NodeNear.Load = new FEM_Explorer.NodalLoad(Model.Members.CurrentMember.NodeNear.Load.X, Model.Members.CurrentMember.NodeNear.Load.Y, -doubleValue_LoadsM.NearValue);
        ...
        {
            Model.Members.CurrentMember.NodeFar.Load = new FEM_Explorer.NodalLoad(Model.Members.CurrentMember.NodeFar.Load.X, Model.Members.CurrentMember.NodeFar.Load.Y, doubleValue_LoadsM.FarValue);
            doubleValue_LoadsM.SetValue(doubleValue_LoadsM.NearValue, doubleValue_LoadsM.FarValue);
        }
