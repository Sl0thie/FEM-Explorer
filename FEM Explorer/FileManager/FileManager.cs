...
namespace FEM_Explorer
{
    internal static class FileManager
    {
            ...
            if (!ReferenceEquals(WorkingFile, null))
            {
                try
                {
                    ...
                    if (StorageApplicationPermissions.MostRecentlyUsedList.ContainsItem(WorkingFileMruToken))
                    {
                        ...
                        //       () =>
                        //       {
                        //           FileLoadingDisplay.Current.AddMessage(-1, -1, "Found MRU Token.");
                        //       }
                        //       );
                    ...
                    else
                    {
                        ...
                        //       () =>
                        //       {
                        //           FileLoadingDisplay.Current.AddMessage(-1, -1, "MRU Token not found.");
                        //       }
                        //       );
        ...
        public static async Task<bool> PickFileToSave()
        {
            ...
            savePicker.SuggestedFileName = WorkingFilePath;
            NextFile = null;
