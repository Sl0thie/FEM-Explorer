...
namespace FEM_Explorer
{
    internal class DMatrix
    {
        ...
        static decimal[][] MatrixRandom(int rows, int cols, decimal minVal, decimal maxVal, int seed)
        {
        ...
        static bool MatrixAreEqual(decimal[][] matrixA, decimal[][] matrixB, decimal epsilon)
        {
        ...
        static decimal[] MatrixVectorProduct(decimal[][] matrix, decimal[] vector)
        {
        ...
        static decimal MatrixDeterminant(decimal[][] matrix)
        {
            int[] perm;
            int toggle;
            decimal[][] lum = MatrixDecompose(matrix, out perm, out toggle);
        ...
        static string VectorAsString(decimal[] vector)
        {
            string s = "";
